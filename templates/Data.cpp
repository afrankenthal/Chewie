...
//  tree->SetBranchAddress("numberOfTelescopeClustersSizeLE2", &numberOfTelescopeClustersSizeLE2_);
  ...
  tree->SetBranchAddress("sigmaXIntercept"                 , &xSigmaIntercept_	               );
  tree->SetBranchAddress("yIntercept"                      , &yIntercept_		       );
  tree->SetBranchAddress("sigmaYIntercept"                 , &ySigmaIntercept_	               );
  tree->SetBranchAddress("xSlope"                          , &xSlope_		               );
  tree->SetBranchAddress("sigmaXSlope"                     , &xSigmaSlope_  	               );
  tree->SetBranchAddress("ySlope"                          , &ySlope_		               );
  tree->SetBranchAddress("sigmaYSlope"                     , &ySigmaSlope_  	               );
...
//  tree->SetBranchAddress("yPixelPitchLocalUnconstrained"   , &yPixelPitchLocalUnconstrained_   );
  tree->SetBranchAddress("clusterHitRow"                   , &clusterPixelRow_	               );
  tree->SetBranchAddress("clusterHitCol"                   , &clusterPixelCol_	               );
  tree->SetBranchAddress("clusterHitCharge"                , &clusterPixelCharge_	       );
  tree->SetBranchAddress("clusterPixelCenterLocalX"	  , &xClusterPixelCenterLocal_         );
  tree->SetBranchAddress("clusterPixelCenterLocalY"	  , &yClusterPixelCenterLocal_         );
  tree->SetBranchAddress("clusterPixelCenterGlobalX"	  , &xClusterPixelCenterGlobal_        );
  tree->SetBranchAddress("clusterPixelCenterGlobalY"	  , &yClusterPixelCenterGlobal_        );
