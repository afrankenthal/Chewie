...
public:
    ...
    int          getClusterPixelRow                 (int  h, int p   )const {return clusterPixelRow_              [h][p];}
    int          getClusterPixelCol                 (int  h, int p   )const {return clusterPixelCol_              [h][p];}
    int          getClusterPixelCharge              (int  h, int p   )const {return clusterPixelCharge_           [h][p];}
    float        getXClusterPixelCenterLocal        (int  h, int p   )const {return xClusterPixelCenterLocal_     [h][p];}
    float        getYClusterPixelCenterLocal        (int  h, int p   )const {return yClusterPixelCenterLocal_     [h][p];}
    float        getXClusterPixelCenterGlobal       (int  h, int p   )const {return xClusterPixelCenterGlobal_    [h][p];}
    float        getYClusterPixelCenterGlobal       (int  h, int p   )const {return yClusterPixelCenterGlobal_    [h][p];}
    bool         getIsPixelCalibrated               (int  h, int p   )const {return isPixelCalibrated_            [h][p];}
