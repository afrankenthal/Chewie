  ...
  for (unsigned int p = 0; p < thePlaneMapping_->getNumberOfPlanes(); p++)
    {
      ...
      //               boolean cut           plane number    data       thread number
      //std::cout<<"Runing planeEfficiency"<<std::endl;
...
//      std::cout << __PRETTY_FUNCTION__ << "Row: " << rowPredicted << " Column: " << colPredicted << std::endl;
  ...
  //std::cout<<"PASS --> "<<thePlaneMapping_->getPlaneName(planeID)<<std::endl;
  ...
  if (theWindow->checkWindowAbout(colPredicted,rowPredicted,run,thePlaneMapping_->getPlaneType(planeID)))
    {
      if(planeID==22 || planeID==23)
      //std::cout << __PRETTY_FUNCTION__ <<"PASS --> windows about" <<std::endl;
...
//=======================================================================
void EfficiencyOuterTracker::xEdgeEfficiency(bool pass, int planeID, const Data& data, int threadNumber)
{
  // #####################
  // # Internal constant #
  // #####################
...
//=======================================================================
void EfficiencyOuterTracker::yEdgeEfficiency(bool pass, int planeID, const Data& data, int threadNumber)
{
  // #####################
  // # Internal constant #
  // #####################
