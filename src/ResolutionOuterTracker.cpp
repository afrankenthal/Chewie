...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ResolutionOuterTracker::ResolutionOuterTracker(AnalysisManager* analysisManager, int nOfThreads) :
...
{
    STDLINE("Running ResolutionOuterTracker analysis",ACCyan) ;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ResolutionOuterTracker::~ResolutionOuterTracker(void)
{
    STDLINE("=======================================================================",ACCyan) ;
    if(thePlaneMapping_)
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::destroy(void)
{
    STDLINE("=======================================================================",ACCyan) ;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::predictedErrors(bool pass, int planeID, const Data& data, int threadNumber)
{
    if(!pass)
        return;
...
/*//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
double ResolutionOuterTracker::smearedSquare(double *xx, double *par){
    //smearedSquare: square function convoluted with a gaussian
    //par[0] = normalization
    //par[1] = center of the function, look for misalignment
    //par[2] = sigma of the gaussian, contains telescope and DUT ResolutionOuterTrackers
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::fitXResiduals(int planeID)
{
    STDLINE("=======================================================================",ACCyan) ;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::fitYResiduals(int planeID)
{
    STDLINE("=======================================================================",ACCyan) ;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::fitXresidualsCalculated(int planeID)
{
    STDLINE("=======================================================================",ACCyan) ;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::fitXresidualsCalculatedSize2(int planeID)
{
    STDLINE("=======================================================================",ACCyan) ;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::fitXresidualsCalculatedSize3(int planeID)
{
    STDLINE("=======================================================================",ACCyan) ;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::fitXresidualsCalculatedSize4(int planeID)
{
    STDLINE("=======================================================================",ACCyan) ;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::fitXresidualsSize2(int planeID)
{
    STDLINE("=======================================================================",ACCyan) ;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::fitXresidualsSize3(int planeID)
{
    STDLINE("=======================================================================",ACCyan) ;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::fitXresidualsSize4(int planeID)
{
    STDLINE("=======================================================================",ACCyan) ;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::fitYresidualsSize2(int planeID)
{
    STDLINE("=======================================================================",ACCyan) ;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::fitYresidualsSize3(int planeID)
{
    STDLINE("=======================================================================",ACCyan) ;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::fitYresidualsSize4(int planeID)
{
    STDLINE("=======================================================================",ACCyan) ;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::fitYresidualsCalculatedSize2(int planeID){
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::fitYresidualsCalculatedSize3(int planeID){
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::fitYresidualsCalculatedSize4(int planeID){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::calculateXresiduals(bool pass, int planeID, const Data &data, int threadNumber)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::calculateYresiduals(bool pass, int planeID, const Data &data, int threadNumber)
{
    if (!pass || !data.getIsInDetector( planeID ) || !data.getHasHit( planeID ) || data.getClusterSize( planeID ) > 4) return;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::xResolutionOuterTracker(bool pass, int planeID, const Data& data, int threadNumber)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::yResolutionOuterTracker(bool pass, int planeID, const Data& data, int threadNumber)
{
    if(!pass || !data.getBelongsToTrack(planeID))
        return;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::setCutsFormula(std::map<std::string,std::string> cutsList, std::vector<TTree*> tree)
{
    ...
    for(std::map<std::string,std::string>::iterator it=cutsList.begin(); it!=cutsList.end(); it++)
    {
        if((it->first) == "main cut" && (it->second).size()==0)
            STDLINE("WARNING: no main cut set in ResolutionOuterTracker analysis!! Default value = true!", ACRed);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool ResolutionOuterTracker::passStandardCuts(int planeID, const Data &data)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool ResolutionOuterTracker::passBadPlanesCut (int planeID, const Data &data)
{
    XmlParser* theParser = theAnalysisManager_->getXmlParser();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::beginJob(void)
{
...
{   
    ...
    bool xResolutionOuterTrackerCut;
    if(cutsFormulas_.find("X ResolutionOuterTracker")!=cutsFormulas_.end())
        xResolutionOuterTrackerCut = cutsFormulas_["X ResolutionOuterTracker"][threadNumber]->EvalInstance();
    else
        xResolutionOuterTrackerCut = true;

    bool yResolutionOuterTrackerCut;
    if(cutsFormulas_.find("Y ResolutionOuterTracker")!=cutsFormulas_.end())
        yResolutionOuterTrackerCut = cutsFormulas_["Y ResolutionOuterTracker"][threadNumber]->EvalInstance();
    else
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::endJob(void)
{
    for(unsigned int p=0; p<thePlaneMapping_->getNumberOfPlanes(); p++)
    {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ResolutionOuterTracker::book(void)
{
    destroy();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
void ResolutionOuterTracker::customProfileX(std::vector<TH2F *>h2D, std::vector<TH1F *>prof, int planeID, const char* outputName, const char* outputTitle, int yBinMin, int yBinMax, int minNumberOfEntries){
