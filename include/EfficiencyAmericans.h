...
#ifndef EFFICIENCYAMERICANS_H
#define EFFICIENCYAMERICANS_H
...
class EfficiencyAmericans : public Analysis
{
 public:
   EfficiencyAmericans     (AnalysisManager* analysisManager = 0, int nOfThreads = 1);
  ~EfficiencyAmericans     (void);
 ...
 private:
  ...
  //<< wsi 07/12/17
  std::vector<TH2F*> hCellEfficiencyOddEvenColumns_;
  std::vector<TH2F*> hCellEfficiencyOddEvenColumnsNorm_;
  std::vector<TProfile*> hCellEfficiencyOddEvenColumnsProfile_;
  std::vector<TProfile*> hCellEfficiencyOddEvenColumnsProfileNorm_;
  //<< wsi 07/12/17

  std::vector<TH1F*> h1DXcellEfficiencyFirstHit_;
  std::vector<TH1F*> h1DXcellEfficiencySecondHit_;
  //>> wsi 11/12/17
  std::vector<TH1F*> h1DXcellEfficiencyFourthHit_;
  //<< wsi 11/12/17
  ...
  //>> wsi 11/12/17
  std::vector<TH1F*> h1DYcellEfficiencyFourthHit_;
  //<< wsi 11/12/17
