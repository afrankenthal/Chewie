...
#ifndef HanSoloTreeBrowser_H
#define HanSoloTreeBrowser_H
...
class HanSoloTreeBrowser : public QTreeWidget
{
    Q_OBJECT
...
public:
    ...
    HanSoloTreeBrowser    (QWidget         * parent,
                     MainWindow      * mainWindow      ) ;
    ~HanSoloTreeBrowser    (void                              ) ;
